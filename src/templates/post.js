  ...
  return (
    <Layout>
      ...
      <div className='flex justify-around container mx-auto md:py-10 flex-col-reverse md:flex-row'>
        <div className=''>
          <div className='flex items-center gap-3 px-4 md:px-0 mb-3'>
          ...
          <h1 className="text-4xl font-bold font-cormorant leading-9 px-4 md:px-0 pb-6">{post.title}</h1>
          <div className='h-0 border-b border-button_black border-opacity-20 w-10'></div>
          <div className="prose max-w-none bold-text px-4 md:px-0 py-6">
            <PortableText

      ...
      <section>
        ...
        <div className="flex flex-col gap-2 items-center px-4 md:px-60 mt-28 md:mt-48 container mx-auto">
          ...
          <p className="basic-text text-center">
            A WineSofi nem csak egy borászat: a természetről, a Badacsonyról és a Balatonról szól. Bemutat egy
            különleges helyet, ahol a vulkáni talaj adta megismételhetetlen egyedi borok születnek. A kis mennyiségben
            készült, számozott palackokba töltött egyedi borok mindegyikében érezhető a butikborászat szakértelme és a
            terroir varázsa.
          </p>
          <div className="flex gap-3 justify-center pt-7">
            <Link to="/borok" className="button h-9">
              Borbutik
            </Link>
          </div>
        </div>
          ...
          <div className="flex flex-wrap justify-center xl:gap-8 flex-col sm:flex-row">
            <div className="flex items-center sm:gap-8 flex-col-reverse sm:flex-row sm:py-16">
              <div className="relative left-6 bottom-10 sm:left-0 sm:bottom-0 z-20 text-right w-64">
                ...
                <p className="font-sans text-sm leading-7 text-wrap text-button_black opacity-60 pb-4">
                  Egyedi borászati kurzusok 4-8 fős csoportok részére.
                </p>
            ...
            <div className="flex items-center sm:gap-8 flex-col sm:flex-row sm:py-16">
              ...
              <div className="relative z-20 w-64 text-right sm:text-left left-6 bottom-10 sm:left-0 sm:bottom-0">
                ...
                <p className="font-sans text-sm leading-7 text-wrap text-button_black opacity-60 pb-4">
                  Személyre szabott borászati szaktanácsadás.
                </p>
        ...
        <div className="container mx-auto flex flex-wrap items-center justify-evenly bg-contain px-4 max-w-7xl gap-8 md:gap-12 sm:flex-row-reverse">
          ...
          <div className="w-full sm:flex-1">
            ...
            <p className="font-sans text-sm leading-7 text-wrap text-button_black opacity-60 pb-4">
              ...
              tapasztalatot a borászat világából. Szakmai tanulmányaimat a Kertészeti Egyetemen, Valenciában és
              Bordeaux-ban végeztem. Emellett dolgoztam Kaliforniában, Burgundiában, Elzászban, Bordeaux-ban,
              Észak-Olaszországban és az akkor még családi vállalkozásként működő Laposa Birtoknál. 2021-ben pedig úgy
              döntöttem, saját utat választok, így született meg az egyedi borokat készítő badacsonyi WineSofi
              butikborászat. „Az ember része a természetnek és az élet körforgásának, melyben teremt és alkot. Ezt a
              lüktető ciklikusságot tapasztalhatjuk testünkön, az időjárás változásain, sőt, még a születés és az
              elmúlás pillanataiban is. Egy pohár borban érezhető az éghajlat, a talaj, a napsütötte órák száma, az
              évjárat sajátosságai, a borász munkája és a természet maga. Mivel minden évjárat egyedi, minden bor más.
              Az ember akkor kerül összhangba önmagával, amikor összhangba kerül a természettel.” Bízom benne, hogy
              egyedi boraimmal sikerül átadnom neked a természet iránti szenvedélyt és tiszteletet.
            </p>
            <div className="flex flex-row justify-center sm:justify-normal mt-2">
              <Link className="button" to="/kapcsolat">
                kapcsolat
              </Link>
            </div>
          </div>
...
export const query = graphql`
  query Blogposts {
    allSanityPost(sort: { _createdAt: DESC }, limit: 2, filter: { language: { eq: "hu" } }) {
      nodes {
        id
        title

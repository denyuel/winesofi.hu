      ...
      <section className='w-full bg-gradient-to-r from-orange to-[#D07C1F]'>
        <div className="container bg-[url('../images/index-bg-object.png')] bg-no-repeat bg-teaser">
          <div className='flex flex-wrap justify-center xl:gap-8 flex-col sm:flex-row '>
            <div className='flex items-center sm:gap-8 flex-col-reverse sm:flex-row'>
              <div className='relative left-16 bottom-16 sm:left-0 sm:bottom-0 z-20 text-right w-64 '>
              ...
              <StaticImage class='relative right-16 sm:right-0 z-10 rounded-full h-64 w-64 mt-8 mb-0 sm:mb-20 sm:mt-12 xl:mt-20' src="../images/index-post-left.jpg" alt="index-post-left" placeholder="blurred" />
            </div>
            <div className='flex items-center sm:gap-8 flex-col sm:flex-row'>
              <StaticImage class='rounded-full right-16 sm:left-0 h-64 w-64 my-0 sm:mb-20 sm:mt-0 xl:mt-20' src="../images/index-post-right.jpg" alt="index-post-right" placeholder="blurred" />
              <div className='relative z-20 w-64 text-right sm:text-left left-16 bottom-16 sm:left-0 sm:bottom-0'>

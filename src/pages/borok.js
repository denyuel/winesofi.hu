              ...
              <div className="prose max-w-none bold-text my-8">
                ...
                <div className="prose max-w-none bold-text my-8">
                  <p>
                    ...
                    veséjében", valamint a Köves-hegy tetején találhatók. A szőlőfajták között megtalálható az
                    olaszrizling, amely a Badacsony-borvidék meghatározó fajtája, a rajnai rizling, ami összehasonlítást
                    biztosít a nemzetközi borvidékekkel és a furmint, ami a vulkáni talajon érzi magát igazán otthon.
                    Van egy öreg tőkékből álló, vegyes kis terület, aminek nagy része Kéknyelű, igazi kuriózum, a régió
                    sokszínűségét és történelmét mutatja be.
                  </p>
                  <p>
                    A "hegy veséje" a borászat szempontjából az arany középút. Példaként Burgundia hozható fel, ahol a
                    borok besorolása három fő kategóriába esik: az alap borokat jelölő "Villages", a hegy tetején
                    található kiemelkedő minőséget képviselő "Premier Cru", és a csúcsminőséget jelentő "Grand Cru",
                    melyek legtöbbször a “hegy veséjében", a hegy közepén találhatók. A hegy közepén a talajerózió
                    mértéke nem túl nagy, a talaj tápanyagellátása ideális, a nap beesési szöge és a szélhatások
                    megfelelők.
                  </p>
                ...
                <div className="prose max-w-none basic-text mt-14">
                  ...
                  <p>
                    ...
                    borászat tudásának és a terroir egyedi jellegének összhangja jelenik meg minden egyes palackban.
                    1278 palack készült belőle.
                  </p>

                  <p>
                    Ez a bor a Badacsony vulkanikus talajának köszönhetően ásványos és gazdag karakterrel büszkélkedik,
                    amelyet a 6 hónapos érlelés 10 hektoliteres ászok hordóban még inkább kiemel. Érett aromák, méz,
                    dió, teafű, kevés fehér virág és ásványoság jellemzi, tökéletes társ a beszélgetésekhez.
                  </p>
                  ...
                  <p>
                    A kéknyelű Badacsonyban található, mindössze 47 hektáron termesztett szőlőfajta, melynek minden
                    cseppje a terroir egyediségét hordozza. Levélnyelének kékes-vöröses árnyalata adja a nevét. Régen
                    “Úri szőlőnek” gúnyolták mivel a szinte kizárólag női virágzatot hoz, így a termesztés során szükség
                    van egy porzó fajtára is (Rózsakő), így magasabb törődést igényel, mint egy átlagos fajta.
                  </p>
                  ...
                  <p>
                    ...
                    ásványosságával válik felejthetetlenné. Ez a tétel virágos és érett jegyekkel mutatkozik be,
                    melyeket finom barack és egy csepp citrus frissesség egészít ki.
                  </p>

                  <p>
                    Ez a bor egy ínyenc tétel, a kéknyelű és Badacsony házassága, mely minden kortyával az egyedi
                    terroir és a fajta jellegzetességeit hordozza magában.
                  </p>

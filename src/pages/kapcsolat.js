    ...
    <Layout>
      <div>
        ...
        <div className='flex flex-col'>
          <div className='flex flex-col md:flex-row justify-center items-center gap-4 md:gap-12 px-4 md:px-20 xl:px-[30rem] py-12'>
            ...
            <div className='flex justify-center h-64 w-11/12 md:w-4/12 -mb-20'>
              <div className='w-64 h-full overflow-hidden z-10 rounded-full'>
            ...
            <form id="contactForm" className="w-full">
              <div className="flex flex-col lg:flex-row justify-center gap-8 w-full py-12 px-4 lg:px-0">
                <div className="flex flex-col gap-1 lg:gap-0 justify-between">
                  <label className="pl-4 text-gray_strong text-xs font-light tracking-[2px] uppercase" for="name">név</label>
                  <input className="w-full md:w-input h-input basic-text border-solid border-gray border rounded-3xl p-4"
                    type="text" id="name" name="name" required />
                  <label className="pl-4 text-gray_strong text-xs font-light tracking-[2px] uppercase" for="email">email</label>
                  <input className="w-full md:w-input h-input basic-text border-solid border-gray border rounded-3xl p-4"
                    type="email" id="email" name="email" required />
                  <label className="pl-4 text-gray_strong text-xs font-light tracking-[2px] uppercase" for="tel">telefon</label>
                  <input className="w-full md:w-input h-input basic-text border-solid border-gray border rounded-3xl p-4"
